import './chunks/astro/server_DgSEdpN0.mjs';
import { g as getActionQueryString, a as astroCalledServerError, A as ActionError, d as deserializeActionResult, b as ACTION_QUERY_PARAMS, c as appendForwardSlash } from './chunks/astro-designed-error-pages_C-BNchek.mjs';
import { d as defineAction, o as objectType, s as stringType } from './chunks/server_rmDcfU8i.mjs';
import { createTransport } from 'nodemailer';
import { c as createInvalidVariablesError, g as getEnv$1, s as setOnSetGetEnv } from './chunks/runtime_DZGcX6x2.mjs';
...
const schema = {"RESEND_API_KEY":{"context":"server","access":"secret","type":"string"}};
...
const server = {
  sendEmail: defineAction({
    ...
    input: objectType({
      ...
      lastName: stringType().min(2).max(100),
      email: stringType().email(),
      message: stringType().min(10).max(500)
    }),
